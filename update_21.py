...
#ru_daily = pd.read_csv("dataset\\2021_ru_wikidaily.csv", encoding = "utf-16")
ru_wiki21 = wiki_analysis.Wiki_all_access("2021_ru_wikidaily.csv", "utf-16")
ru_wiki21.barplot_month(6)
ru_wiki21.article_heatmap("Моргенштерн (музыкант)", 1)

# Visualization
wiki_visual.lang_plot(es_wiki21.get_df(), "total", "Spanish", 2021)
wiki_visual.lang_plot(en_wiki21.get_df(), "total", "English", 2021)
wiki_visual.lang_plot(ru_wiki21.get_df(), "total", "Russian", 2021)
